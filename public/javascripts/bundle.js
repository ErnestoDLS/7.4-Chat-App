...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formSerialize = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"form-serialize\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    setInterval(function () {
	      _jquery2.default.get(_this.props.source, function (resp) {
	        _this.setState({ messages: resp });
	        console.log(resp);
	      });
	    }, 2000);
	  },
	  handleSubmitForm: function handleSubmitForm(e) {
	    ...
	    e.preventDefault();
	    var serializedForm = (0, _formSerialize2.default)(this.refs.userForm, { hash: true });
	    _jquery2.default.post(this.props.source, serializedForm, function (resp) {
	      _jquery2.default.get(_this2.props.source, function (resp) {
	        _this2.setState({ users: resp });
	      });
	      _this2.refs.input.value = "";
	    });
	  },
	  handleUserDelete: function handleUserDelete(e) {
	    var _this3 = this;

	    var userId = (0, _jquery2.default)(e.target).parent().data("id");
	    _jquery2.default.ajax({
	      url: this.props.source + '/' + userId,
	      method: "DELETE",
	      dataType: "JSON",
	      success: function success(resp) {
	        _jquery2.default.get(_this3.props.source, function (resp) {
	          _this3.setState({ users: resp });
	        });
	      }
	    });
	  },
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'form',
	        { className: 'form', method: 'POST', ref: 'userForm', action: '#', onSubmit: this.handleSubmitForm },
	        _react2.default.createElement('input', { className: 'input_bar', autoComplete: 'Off', type: 'text', ref: 'input', name: 'username', placeholder: 'please clap' }),
	      ...
	      _react2.default.createElement(
	        ...
	        this.state.users.map(function (user) {
	          return _react2.default.createElement(
	            ...
	            user.username,
	            _react2.default.createElement('span', { onClick: _this4.handleUserDelete }),
	            _react2.default.createElement('i', { onClick: _this4.handleUserDelete, className: 'fa fa-times-circle' })
	          );
	        }, this)
	      )
	    );
